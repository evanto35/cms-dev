        ...
        <div class="fll basket_form">
            <div form="true" class="wForm regBlock" data-ajax="checkout">
                <div class="wBasketHead">
                    <div class="wBasketTTL">Оформление заказа</div>
                </div>
                <div class="wFormRow">
                ...
                <div class="wFormRow">
                    ...
                    <input data-name="number" type="text" class="dostavka" name="number"
                           placeholder="Введите номер отделения Новой Почты" data-rule-required="true">
                </div>
                <div class="wFormRow">
                ...
                <div class="wFormRow">
                    <input type="tel" data-name="phone" class="tel" name="phone" data-rule-phoneUA="true" maxlength="19"
                           minlength="19" placeholder="Телефон" data-rule-data-rule-required="truetrue">
                    <label>Телефон</label>
                </div>
                                ...
                                <li class="wb_item" data-id="<?php echo $obj->id; ?>"
                                    ...
                                    <div class="wb_li">
                                        ...
                                        <div class="wb_content">
                                            <div class="wb_row">
                                                <div class="wb_del"><span title="Удалить товар">Удалить товар</span>
                                                </div>
                                                <div class="wb_ttl">
                                                    <a href="<?php echo HTML::link($obj->alias . '/p' . $obj->id); ?>"
                                                       class="wbLeave">
                ...
                <div class="wBasketFooter">
                    <div class="wb_footer">
                        <div class="tar wb_footer_tot">
                            <div class="wb_total">Итого: <span id="topCartAmount"><?php echo $amount; ?></span> грн.
                            </div>
                        </div>
                        <div class="flr wb_footer_go">
                            <div class="wb_gobasket">
                                <a href="<?php echo HTML::link('products'); ?>"
                                   class="wb_butt"><span>Продолжить покупки</span></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php else: ?>
    <p class="emptyCartBlock">Ваша корзина пуста. <a href="<?php echo HTML::link('products'); ?>">Начните делать
