    ...
    <div class="wSize">
        ...
        <div class="head_center">
            ...
            <div class="flr">
                ...
                <?php else: ?>
                    <a href="<?php echo HTML::link('account'); ?>" class="basket enter"><span>Кабинет</span></a>
                    <a href="<?php echo HTML::link('account/logout'); ?>" class="basket"><span>Выход</span></a>
                <?php endif ?>
                <a href="<?php echo HTML::link('cart'); ?>" class="basket"><span>Корзина</span></a>
