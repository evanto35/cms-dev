    ...
    <div class="stat_slider_block">
        <ul class="stat_slider">
            <?php foreach ($result as $obj): ?>
                <li class="stat_block">
                    <?php if (is_file(HOST . HTML::media('/images/articles/small/' . $obj->image))): ?>
                    ...
                    <div class="opus_block">
                        ...
                        <div class="clear"></div>
                        <a href="<?php echo HTML::link('articles/' . $obj->alias); ?>" class="opus_but">подробнее...</a>
                    </div>
                </li>
            <?php endforeach; ?>
        </ul>
    </div>
    <a href="<?php echo HTML::link('articles'); ?>" class="slide_but">архив статей</a>
    <div class="prev2">
        <div class="arrow"></div>
    </div>
    <div class="next2">
