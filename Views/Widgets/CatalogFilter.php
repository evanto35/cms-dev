...
<form action="">
    <ul class="main_filt">
        ...
        <li data-key="available">
            ...
            <ul class="nall">
                <li><?php echo Filter::generateElseInput($filter, 'в наличии', 1, 'available'); ?></li>
                <li><?php echo Filter::generateElseInput($filter, 'под заказ', 2, 'available'); ?></li>
                <li><?php echo Filter::generateElseInput($filter, 'нет в наличии', 0, 'available'); ?></li>
            </ul>
        </li>
        <?php if ($max): ?>
            <li data-key="cost">
