...
class Common
{
    ...
    public static function uploadImage($id, $name = 'file', $field = 'image')
    {
		...
		if (Config::get('main.mobile') and isset(static::$mobile_image)) {
			Files::uploadImage(static::$mobile_image, $name, $filename);
		}
    ...
    public static function deleteImage($filename, $id = null, $field = 'image')
    {
		...
		// delete images for mobile
		if (Config::get('main.mobile') and isset(static::$mobile_image)) {
			Files::deleteImage(static::$mobile_image, $filename);
		}
