...
class Form extends Ajax
{
    ...
    // Checkout your order
    public function checkoutAction($number)
    {
        ...
        $this->success(['redirect' => User::info() ? $link_user : '/cart']);
    }
    ...
    public function subscribeAction()
    {
        ...
        $ip = System::getRealIP();
        $lastID = DB::insert('subscribers', ['email', 'ip', 'status', 'hash', 'created_at'])->values([email, $ip, 1, $hash, time()])->execute();
        $lastID = Arr::get($lastID, 0);
